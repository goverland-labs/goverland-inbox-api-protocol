...
const (
	Subscription_Subscribe_FullMethodName         = "/internalapi.Subscription/Subscribe"
	Subscription_Unsubscribe_FullMethodName       = "/internalapi.Subscription/Unsubscribe"
	Subscription_ListSubscriptions_FullMethodName = "/internalapi.Subscription/ListSubscriptions"
	Subscription_GetSubscription_FullMethodName   = "/internalapi.Subscription/GetSubscription"
	Subscription_FindSubscribers_FullMethodName   = "/internalapi.Subscription/FindSubscribers"
)
...
func (c *subscriptionClient) ListSubscriptions(ctx context.Context, in *ListSubscriptionRequest, opts ...grpc.CallOption) (*ListSubscriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, Subscription_ListSubscriptions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *subscriptionClient) GetSubscription(ctx context.Context, in *GetSubscriptionRequest, opts ...grpc.CallOption) (*SubscriptionInfo, error) {
	out := new(SubscriptionInfo)
	err := c.cc.Invoke(ctx, Subscription_GetSubscription_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *subscriptionClient) FindSubscribers(ctx context.Context, in *FindSubscribersRequest, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
	err := c.cc.Invoke(ctx, Subscription_FindSubscribers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Subscription_FindSubscribers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Subscription_FindSubscribers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
