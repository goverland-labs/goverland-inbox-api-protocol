...
type FeedClient interface {
	...
	MarkAsUnarchived(ctx context.Context, in *MarkAsUnrchivedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *feedClient) MarkAsUnarchived(ctx context.Context, in *MarkAsUnrchivedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type FeedServer interface {
	...
	MarkAsUnarchived(context.Context, *MarkAsUnrchivedRequest) (*emptypb.Empty, error)
...
func (UnimplementedFeedServer) MarkAsUnarchived(context.Context, *MarkAsUnrchivedRequest) (*emptypb.Empty, error) {
...
func _Feed_MarkAsUnarchived_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServer).MarkAsUnarchived(ctx, req.(*MarkAsUnrchivedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
